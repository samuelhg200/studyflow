			...
			<ScrollView>
				<View style={styles.screen}>
					...
					<Layout style={styles.textContainer}>
						...
						<Text style={styles.paragraph}>
							You will be able to choose the length and frequency of these
							sessions. We will quickly ask for your feedback after a StudyFlow
							and adapt your future sessions to help you remain focused and
							engaged.
						</Text>
					</Layout>
					<Button
